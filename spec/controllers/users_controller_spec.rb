    ...
    context "when is not connected" do
      ...
      describe "#update" do
        it "should render status unauthorized" do
          ...
          put :update, id: user.id, user: attributes_for(:user, agency_id: @agency.id)
      ...
      context "when user have not the authorization to do" do
        ...
        describe "#index" do
          ...
          it "should render nothing in body" do
            ...
            expect(response.body).not_to eq(User.all)
          end
        end
        describe "#show" do
        ...
        describe "#update" do
          ...
          it "should render status unauthorized if is not his profile" do
            ...
            put :update, id: new_user.id, user: attributes_for(:user, agency_id: @agency.id)
