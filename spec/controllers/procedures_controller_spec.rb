...
RSpec.describe ProceduresController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all procedures as @procedures" do
      ...
      expect(assigns(:procedures)).to eq([procedure])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new procedure as @procedure" do
      ...
      expect(assigns(:procedure)).to be_a_new(Procedure)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created procedure as @procedure" do
        post :create, {:procedure => valid_attributes}, valid_session
        expect(assigns(:procedure)).to be_a(Procedure)
        expect(assigns(:procedure)).to be_persisted
      end

      it "redirects to the created procedure" do
        post :create, {:procedure => valid_attributes}, valid_session
        expect(response).to redirect_to(Procedure.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved procedure as @procedure" do
        post :create, {:procedure => invalid_attributes}, valid_session
        expect(assigns(:procedure)).to be_a_new(Procedure)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested procedure" do
        procedure = Procedure.create! valid_attributes
        put :update, {:id => procedure.to_param, :procedure => new_attributes}, valid_session
        procedure.reload
      ...
      it "redirects to the procedure" do
        procedure = Procedure.create! valid_attributes
        put :update, {:id => procedure.to_param, :procedure => valid_attributes}, valid_session
        expect(response).to redirect_to(procedure)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the procedure as @procedure" do
        procedure = Procedure.create! valid_attributes
        put :update, {:id => procedure.to_param, :procedure => invalid_attributes}, valid_session
        expect(assigns(:procedure)).to eq(procedure)
      end
