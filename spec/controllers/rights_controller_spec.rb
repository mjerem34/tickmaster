...
RSpec.describe RightsController, type: :controller do
  ...
  #  Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #index" do
    it "assigns all rights as @rights" do
      ...
      expect(assigns(:rights)).to eq([right])
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved right as @right" do
        post :create, {:right => invalid_attributes}, valid_session
        expect(assigns(:right)).to be_a_new(Right)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested right" do
        right = Right.create! valid_attributes
        put :update, {:id => right.to_param, :right => new_attributes}, valid_session
        right.reload
    ...
    context "with invalid params" do
      it "assigns the right as @right" do
        right = Right.create! valid_attributes
        put :update, {:id => right.to_param, :right => invalid_attributes}, valid_session
        expect(assigns(:right)).to eq(right)
      end
