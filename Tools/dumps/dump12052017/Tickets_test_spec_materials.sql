...
CREATE TABLE `spec_materials` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_spec_materials_on_spec_type_material_id` (`spec_type_material_id`),
  CONSTRAINT `fk_rails_c44f0c5fbc` FOREIGN KEY (`spec_type_material_id`) REFERENCES `spec_type_materials` (`id`)
