...
CREATE TABLE `type_material_sellers` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_type_material_sellers_on_type_material_id` (`type_material_id`),
  KEY `index_type_material_sellers_on_seller_id` (`seller_id`),
  CONSTRAINT `fk_rails_0641584172` FOREIGN KEY (`seller_id`) REFERENCES `sellers` (`id`),
  CONSTRAINT `fk_rails_64a8fdf27c` FOREIGN KEY (`type_material_id`) REFERENCES `type_materials` (`id`)
