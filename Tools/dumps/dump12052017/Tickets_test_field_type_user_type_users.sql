...
CREATE TABLE `field_type_user_type_users` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_field_type_user_type_users_on_type_user_id` (`type_user_id`),
  KEY `index_field_type_user_type_users_on_field_type_user_id` (`field_type_user_id`),
  CONSTRAINT `fk_rails_96dfaf93a7` FOREIGN KEY (`field_type_user_id`) REFERENCES `field_type_users` (`id`),
  CONSTRAINT `fk_rails_cd4ef7293b` FOREIGN KEY (`type_user_id`) REFERENCES `type_users` (`id`)
