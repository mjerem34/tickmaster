...
CREATE TABLE `spec_material_materials` (
  ...
  KEY `index_spec_material_materials_on_spec_material_id` (`spec_material_id`),
  KEY `index_spec_material_materials_on_material_id` (`material_id`),
  CONSTRAINT `fk_rails_2b6cadb2ba` FOREIGN KEY (`spec_material_id`) REFERENCES `spec_materials` (`id`),
  CONSTRAINT `fk_rails_76bc4cde93` FOREIGN KEY (`material_id`) REFERENCES `materials` (`id`)
